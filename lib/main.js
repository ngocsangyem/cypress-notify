...
var require$$0$4 = require('querystring');
...
utils$c.toCommandProperties = utils$c.toCommandValue = void 0;
/**
...
utils$c.toCommandValue = toCommandValue;
/**
 *
...
utils$c.toCommandProperties = toCommandProperties;
...
const os$2 = __importStar$2(require$$0$1);
const utils_1$1 = utils$c;
/**
 * Commands
 *
 * Command Format:
...
// We use any as a valid input type
/* eslint-disable @typescript-eslint/no-explicit-any */
const fs$1 = __importStar$1(require$$0$3);
...
function issueFileCommand(command, message) {
    ...
    fs$1.appendFileSync(filePath, `${utils_1.toCommandValue(message)}${os$1.EOL}`, {
        encoding: 'utf8'
    });
}
...
function requireFollowRedirects () {
	...
	var Writable = require$$1$4.Writable;
...
function requireWebClient () {
	...
	(function (exports) {
		...
		const querystring_1 = require$$0$4;
		const path_1 = require$$1$2;
...
var minimatch_1$2 = minimatch;
minimatch.Minimatch = Minimatch;

var path$2 = (function () { try { return require('path') } catch (e) {}}()) || {
  sep: '/'
};
...
var minimatch_1$1 = minimatch_1$2;
var matcherCollection = /** @class */ (function () {
    function MatcherCollection(matchers) {
        this.matchers = matchers.map(function (matcher) {
            return typeof matcher === 'string' ? new minimatch_1$1.Minimatch(matcher) : matcher;
        });
    }
...
const fsNode = require$$0$3;
const MatcherCollection = matcherCollection;
const ensurePosix = ensurePosixPath;
const path = require$$1$2;
const minimatch_1 = minimatch_1$2;
...
(async () => {
    ...
    const screenshots = walkSync_1(workdir, { globs: ['**/*.png'] });
